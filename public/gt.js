window.initGeetest = (function(e) {
    ...
    function(e, t, s) {
        ...
        (i.prototype = {
            ...
            (l.prototype = {
                ...
                _hide: function() {
                    return this._setStyles({ display: "none" });
                },
                _show: function() {
                    return this._setStyles({ display: "block" });
                },
                _opacity: function(e) {
                    return this._setStyles({ opacity: e });
                },
                _getAttr: function(e) {
                ...
                _toggleClass: function(e) {
                    var t = this,
                        s = t._ele;
                    return (
                        -1 === new i(s.className ? s.className.split(" ") : [])._indexOf(a + e)
                            ? t._addClass(e)
                            : t._removeClass(e),
                        t
                    );
                ...
                _clone: function(e) {
                    var t,
                        ...
                        o = n._ele,
                        r = !(
                            (s = document.createElement("canvas")).getContext && s.getContext("2d")
                        );
                    if (e) {
                        if (r) {
                ...
                _getElementLeft: function() {
                    for (var e = this._ele, t = e.offsetLeft, s = e.offsetParent; null !== s; )
                        (t += s.offsetLeft), (s = s.offsetParent);
                    return t;
                },
                _getElementTop: function() {
                    for (var e = this._ele, t = e.offsetTop, s = e.offsetParent; null !== s; )
    ...
    function(e, t, s) {
        ...
        var l = function(e) {
            ...
            f = function(e, t, s, n) {
                ...
                if (s.offline) n({ type: "fullpage", offline: !0 });
                else {
                    var o = "geetest_" + (parseInt(1e4 * r.random()) + new Date().valueOf());
                    (window[o] = function(e) {
                        "success" == e.status
                            ? n(e.data)
                            : e.status
                            ? n({ type: "fullpage", offline: !0 })
                            : n(e),
                            (window[o] = undefined);
                        try {
                            delete window[o];
                        ...
                        u(s, !0, s.protocol, e, t, { gt: s.gt, callback: o }, function(e) {
                            e && n({ type: "fullpage", offline: !0 });
                        });
                }
            },
            h = function(e, t) {
            ...
            m = function(e, t) {
                var s = { networkError: "网络错误", gtTypeError: "gt字段不是字符串类型" };
        ...
        (x.prototype = {
            ...
            _onStatusChange: function(e, t) {
                var s = this._ui,
                    ...
                    a = "bind" === r.product;
                if (!n._equal(t) && t !== m)
                    if ((n._equal(w) || (s && s._onChangeStatus(e, t), s && s._tip()), n._equal(w)))
    ...
    function(e, t, s) {
        ...
        (D.prototype = {
            ...
            _tip: function() {
                ...
                if (s) {
                    ...
                    if (
                        ...
                        if (
                            (s(".radar_tip")
                                ._setAttrs({ tabIndex: "0", "aria-label": e[n] })
                                ._setStyles({ "outline-width": 0 }),
                            t._equal(z))
                        )
            ...
            _init: function() {
                ...
                return (
                    "bind" === s.product
                        ? s.logo || t(".panel_footer")._setStyles({ display: "none" })
                        : (a && s.logo) ||
                          (s.logo
                              ? (t(".logo")._setProps({ target: "_blank", href: s.homepage }),
            ...
            _rotate: function(e) {
                ...
                _ < 0 && (l += 180), n._setStyles({ transform: "rotate(" + l + "deg)" });
            },
            _fullpage: function() {
                var e = this._status;
                e._equal(C) && e._set(E);
            ...
            _compute: function() {
                var e = this._config;
                this._captcha._fullpageHandler({ result: "success", validate: e.challenge });
            },
            _reset: function() {
                var e = this._status,
                    t = this.$,
            ...
            _zoom: function() {
                var e = this._config;
                return this._dom._setStyles({ width: e.width || toRem(this._WIDTH) }), this;
            },
            _loadSkin: function() {
                var e = new u("style");
                ...
                if (e === z)
                    if ((s(".holder")._replaceClass(e, t || null), this._css3))
                        s(".ghost_success")._addClass("success_animate"),
                            ...
                            s(".success_btn")._setStyles({ width: s(".holder")._width() + "px" }),
                            setTimeout(function() {
                                s(".success_btn")._setStyles({ width: "100%" });
                            }, 2e3);
                    else {
                        var n = this._config;
            ...
            _appendTo: function(e) {
                ...
                return (
                    this._box ||
                        this._button ||
                        ((this._box = u.$(e)), this._addEvent(), this._dom._appendTo(this._box)),
                    this
                );
            },
            _bindForm: function(e) {
            ...
            _success: function(e) {
                var t = this,
                    s = t._config;
                "bind" === s.product && (s.pure || (t._panelShowSuccess(), t._panelRemove())),
                    t._setForm(e);
            },
            _setForm: function(e) {
                var t = this.$;
                t(".challenge")._setAttrs({ value: e.geetest_challenge }),
                    t(".validate")._setAttrs({ value: e.geetest_validate }),
                    t(".seccode")._setAttrs({ value: e.geetest_seccode });
            },
            _clearForm: function() {
                var e = this.$;
                return (
            ...
            _panelShow: function() {
                ...
                e(".panel_loading")._hide(),
                    ...
                    i && e(".panel_box")._setStyles({ marginLeft: "0", marginTop: "0" });
            },
            _panelRemove: function() {
                ...
                e(".panel_box")._removeClass("panelshowclick"),
                    ...
                    e(".panel_box")._setStyles({ width: "", height: "" });
            },
            _panelHide: function() {
                var e = this.$;
                e(".panel")._opacity(0),
            ...
            _panelShowSuccess: function() {
                var e = this.$;
                this._panelShowPanel(), e(".panel_success")._show(), this._show_panel_footer();
            },
    ...
    function(e, t, s) {
        ...
        e.exports = function(e) {
            ...
            return e && e.offline && new n(["zh-cn", "en", "zh-hk"])._indexOf(e.lang) > -1
                ? o[e.lang]
                : o["zh-cn"];
        };
    },
        ...
        e.exports = {
            compile: function g(e, t, s) {
                ...
                return (
                    s("." + n[1], d),
                    "input" == i
                        ? d._setAttrs({ type: "hidden", name: c })
                        : d._setProps({ className: c }),
                    _(t)
                        ? d._setAttrs({ textContent: t })
    ...
    function(e, t, s) {
        ...
        (o.prototype = {
            ...
            _equal: function(e) {
                for (var t = n._isArray(e) ? e : [e], s = 0, o = t.length; s < o; s += 1)
