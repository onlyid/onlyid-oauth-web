    ...
    (function(e) {
        ...
        (E.createCanvas = function(e, t, i) {
            ...
            (E.getTransformedOptions = function(e, t) {
                ...
                return (
                    (i.crop = !0),
                    o < (n = e.naturalWidth || e.width) / (r = e.naturalHeight || e.height)
            ...
            (E.scale = function(e, t, i) {
                ...
                if (
                    ...
                    h && a && n && t.crop
                        ? (g = s / l - (b = a) / (y = n)) < 0
                            ? ((l = (n * s) / a),
                              t.top === undefined && t.bottom === undefined && (f = (A - l) / 2))
                            : 0 < g &&
                              ((s = (a * l) / n),
                              t.left === undefined && t.right === undefined && (c = (p - s) / 2))
                    ...
                    if (
                        (1 < (u = t.pixelRatio) &&
                            (!e.style.width ||
                                Math.floor(parseFloat(e.style.width, 10)) !== Math.floor(p / u)) &&
                            ((b *= u), (y *= u)),
                    ...
                    return (
                        ...
                        E.drawImage(e, m, c, f, s, l, b, y, t).setTransform(1, 0, 0, 1, 0, 0),
                        m
                    );
                }
                ...
                (t.orientation = 2 === i.width && 3 === i.height),
                    t.orientation &&
                        ...
                        (t.orientationCropBug =
                            "255,255,255,255" !== e.getImageData(0, 0, 1, 1).data.toString()));
            }),
            (i.src =
                ...
                28 === e.getUint8(d) &&
                    ...
                    (n && !n[l]) ||
                        ...
                        (a.iptc[l] =
                            ((c = a.iptc[l]),
                            (f = o),
                            c === undefined ? f : c instanceof Array ? (c.push(f), c) : [c, f])),
