<template>
  <div id="content">
    ...
    <div style="color: #7f7f7f;">
      <p>欢迎使用唯ID，我是项目发起人ltb，前招行Java工程师，现为平安高级Web开发工程师。</p>
      <p>我一直坚信：<span class="emphasize">账号和言论自由、互联网安全一样，是人们的基本权利</span>，所以我在<span class="emphasize">2017年6月12日</span>发起了唯ID项目。</p>
      <p>唯ID是通用的账号和认证平台，用户只需要在一个接入唯ID的应用注册，即可在所有应用使用。</p>
    </div>
    <div class="advantage">
    ...
    <div class="advantage">
      <i class="iconfont advantage-image" id="github">&#xe6f6;</i>
      <p class="advantage-title">开源、自由，自豪地采用GPLv3协议，托管在<a href="https://github.com/lltb" target="_blank">github</a></p>
    </div>
    <div class="advantage">
